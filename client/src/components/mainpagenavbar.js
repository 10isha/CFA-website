...
export default function MainNav(){
    ...
    return (
      <div class="bg-slate-100 shadow-2xl shadow-black z-10">
            ...
            <ul class="flex items-center hidden space-x-8 lg:flex">
              <li>
                <a
                  ...
                  title="Our product"
                  className="font-medium text-black tracking-wide  transition-colors duration-200 hover:text-teal-accent-400"
                >
                  Home
                </a>
              </li>
