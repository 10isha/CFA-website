    ...
    <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
            ...
            <div className="p-12 md:w-1/2 flex flex-col items-start">
                <span className="inline-block py-1 px-2 rounded bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest">Registrations Closed</span>
                <h2 className="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-4">A PRIMER COURSE ON DATA SCIENCE AND MACHINE LEARNING</h2>
                ...
                <div>
                   <h2 class="animate-typing overflow-hidden border-r-4 border-r-white text-3xl text-black font-bold">Python</h2>
               </div>
            </div>
            {/* <div className="p-12 md:w-1/2 flex flex-col items-start">
